...
public class Productos {
    ...
    public Productos(int id_producto, String nombre_producto, String descripcion_producto, Marcas marca, Categorias categoria, Rubros rubro, Ubicaciones ubicacion, int stockmin_producto, int stockmax_producto, String codigo_producto, int precio_compra_producto, int precio_venta_producto, int iva_producto) {
